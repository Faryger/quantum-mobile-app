...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: ForgotPassStep3Widget.routeName,
          path: ForgotPassStep3Widget.routePath,
          builder: (context, params) => ForgotPassStep3Widget(),
        ),
        FFRoute(
          name: PermisesListWidget.routeName,
          path: PermisesListWidget.routePath,
          builder: (context, params) => PermisesListWidget(),
        ),
        FFRoute(
          name: CameraScanWidget.routeName,
          path: CameraScanWidget.routePath,
          builder: (context, params) => CameraScanWidget(),
        ),
        FFRoute(
