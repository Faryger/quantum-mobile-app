...
class _ContractViewState extends State<ContractView> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('Contratos', style: TextStyle(fontFamily: 'Outfit', fontWeight: FontWeight.w700)),
      ...
      body: FutureBuilder<List<dynamic>>(
        ...
        builder: (context, snapshot) {
          ...
          if (!snapshot.hasData || snapshot.data!.isEmpty) return const Center(child: Text('Sin registros de contratos', style: TextStyle(fontFamily: 'Readex Pro')));
                ...
                child: Row(
                  children: [
                    Container(
                      ...
                      child: const Icon(Icons.description_rounded, color: Color(0xFF14B8A6), size: 20),
                    ),
                    ...
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          Text("Contrato #${item['id']}", style: const TextStyle(fontWeight: FontWeight.w700, color: Color(0xFF1E293B))),
                          Text("Valor: ${item['value'] ?? '0.0'} | Inicio: ${item['start_date']}", style: const TextStyle(fontSize: 12, color: Color(0xFF64748B))),
                        ],
                      ),
                    ),
                  ],
