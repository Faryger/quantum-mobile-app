...
class _ScheduleViewState extends State<ScheduleView> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('Horarios', style: TextStyle(fontFamily: 'Outfit', fontWeight: FontWeight.w700)),
      ...
      body: FutureBuilder<List<dynamic>>(
        ...
        builder: (context, snapshot) {
          ...
          if (!snapshot.hasData || snapshot.data!.isEmpty) return const Center(child: Text('Sin registros de horarios', style: TextStyle(fontFamily: 'Readex Pro')));
                  ...
                  children: [
                    ...
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          Text("ID: ${item['id'] ?? 'N/A'}", style: const TextStyle(fontWeight: FontWeight.w700, color: Color(0xFF1E293B))),
                          Text("Entrada: ${item['check_in_time']} | Salida: ${item['departure_time']}", style: const TextStyle(fontSize: 12, color: Color(0xFF64748B))),
                        ],
                      ),
                    ),
                  ],
